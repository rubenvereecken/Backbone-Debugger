...
extensionUrl = injectionData["extensionUrl"]

# Configuration
basePath = extensionUrl + "js/backboneAgent/"
load = (modulePath) ->
  xmlhttp = new XMLHttpRequest()
  sourceUrl = basePath + modulePath + ".js"
  xmlhttp.open "GET", sourceUrl, false # synchronous
  xmlhttp.onreadystatechange = ->
    eval_ "//@ sourceURL=" + sourceUrl + "\n" + xmlhttp.responseText  if xmlhttp.status is 200 and xmlhttp.readyState is 4
    return
